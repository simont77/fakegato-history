...
### Persistance
There is a persistance possible to avoid to lost all history not yet downloaded by Eve on restart or system crash. The persistance is written every 10min for "weather" and "room" / every event for "door" and "motion" + every 10 min. Thus the maximum loss is 10min.
